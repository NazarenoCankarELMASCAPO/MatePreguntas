...
let clicked = false
let roulette = ["Potenciacion", "Radicacion", "Multiplicacion", "Division", "Calculos combinados", "Simela", "Multiplos", "Primos", "Ecuaciones"];
...
let rouletteOpt = ["division", "multiplicacion", "potenciacion", "radicacion", "calculos-combinados", "simela", "multiplos", "primos", "ecuaciones"];
let rouletteImages = [];
let stick = {
  x: canvas.width / 2 - 5,
  y: -5,
